...
from src.CreditCardDefaultPrediction.utlis.utils import load_object
...
class custom_data:
    def __init__(self,LIMIT_BAL:float,SEX:int,EDUCATION:int,MARRIAGE:int,AGE:int,PAY_0:int,PAY_2:int,
                 PAY_3:int,PAY_4:int,PAY_5:int,PAY_6:int,BILL_AMT1:float,BILL_AMT6:float,
